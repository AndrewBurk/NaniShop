...
LoginCtrl.controller('loginController', ['$scope', '$location', 'UserServices', function ($scope, $location, UserServices) {
...
LoginCtrl.controller('logoutController', ['$scope', '$location', 'UserServices', function ($scope, $location, UserServices) {
...
LoginCtrl.controller('registerController', ['$scope', '$location', 'UserServices', function ($scope, $location, UserServices) {
